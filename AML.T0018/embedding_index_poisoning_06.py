...
# CWE: CWE-284
# SEVERITY: High
# DESCRIPTION: Vector index poisonable via unauthenticated document insertion, variant 6
...
collection = client.get_or_create_collection(f"docs_6")
embedder = SentenceTransformer("all-MiniLM-L6-v2")
@app.route(f"/add-doc/6", methods=["POST"])  # VULNERABLE: no auth, anyone can add docs
def add_doc_6():
