...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 84
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-84"
def query_84(text: str) -> str:
