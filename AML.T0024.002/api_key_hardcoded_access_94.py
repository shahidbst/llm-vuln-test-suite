...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 94
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-94"
def query_94(text: str) -> str:
