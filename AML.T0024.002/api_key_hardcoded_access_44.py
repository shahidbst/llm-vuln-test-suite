...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 44
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-44"
def query_44(text: str) -> str:
