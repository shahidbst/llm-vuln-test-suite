...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 4
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-4"
def query_4(text: str) -> str:
