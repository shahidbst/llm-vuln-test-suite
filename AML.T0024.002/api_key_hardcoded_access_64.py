...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 64
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-64"
def query_64(text: str) -> str:
