...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 24
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-24"
def query_24(text: str) -> str:
