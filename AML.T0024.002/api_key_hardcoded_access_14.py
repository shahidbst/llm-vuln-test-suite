...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: Hardcoded API key in client code enables unlimited model access for extraction, variant 14
...
openai.api_key = "sk-hardcoded-key-exposed-in-repo-14"
def query_14(text: str) -> str:
