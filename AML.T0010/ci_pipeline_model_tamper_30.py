...
# CWE: CWE-1021
# SEVERITY: Critical
# DESCRIPTION: CI/CD pipeline pulls model from external registry without integrity check, variant 30
...
# RUN python -c "from transformers import AutoModel; AutoModel.from_pretrained('org/model-30')"
# Model downloaded at build time without hash verification
import os
os.system(f"python -c \"from transformers import AutoModel; "
          f"AutoModel.from_pretrained('org/model-30')\""  )
