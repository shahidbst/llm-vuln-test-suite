...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 89
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-89")
def embed_89(text: str) -> list:
