...
# CWE: CWE-494
# SEVERITY: Critical
# DESCRIPTION: Typosquatted LLM library installed instead of legitimate package, variant 37
...
import subprocess
subprocess.run(["pip","install",f"openai-37"])  # possible typosquat
# Legitimate package is 'openai'; 'openai-37' may be malicious
