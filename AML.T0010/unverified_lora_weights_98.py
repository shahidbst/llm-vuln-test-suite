...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 98
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-98")
def generate_98(text: str) -> str:
