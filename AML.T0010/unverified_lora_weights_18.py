...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 18
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-18")
def generate_18(text: str) -> str:
