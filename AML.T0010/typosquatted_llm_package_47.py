...
# CWE: CWE-494
# SEVERITY: Critical
# DESCRIPTION: Typosquatted LLM library installed instead of legitimate package, variant 47
...
import subprocess
subprocess.run(["pip","install",f"openai-47"])  # possible typosquat
# Legitimate package is 'openai'; 'openai-47' may be malicious
