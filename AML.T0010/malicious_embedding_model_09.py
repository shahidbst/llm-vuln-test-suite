...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 9
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-9")
def embed_9(text: str) -> list:
