...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: LangChain tool loaded from third-party source without review, variant 65
...
tools = load_tools([f"community-tool-65"])  # third-party tool code not audited
llm = OpenAI()
