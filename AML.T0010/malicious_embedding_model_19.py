...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 19
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-19")
def embed_19(text: str) -> list:
