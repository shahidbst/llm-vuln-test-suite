...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 79
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-79")
def embed_79(text: str) -> list:
