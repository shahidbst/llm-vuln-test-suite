...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: LangChain tool loaded from third-party source without review, variant 5
...
tools = load_tools([f"community-tool-5"])  # third-party tool code not audited
llm = OpenAI()
