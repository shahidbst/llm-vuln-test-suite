...
# CWE: CWE-915
# SEVERITY: High
# DESCRIPTION: Vector database populated from untrusted external source, variant 76
...
collection = client.create_collection(f"knowledge_76")
external_docs = __import__("requests").get(f"https://third-party.com/docs/76").json()
