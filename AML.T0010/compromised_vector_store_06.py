...
# CWE: CWE-915
# SEVERITY: High
# DESCRIPTION: Vector database populated from untrusted external source, variant 6
...
collection = client.create_collection(f"knowledge_6")
external_docs = __import__("requests").get(f"https://third-party.com/docs/6").json()
