...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 8
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-8")
def generate_8(text: str) -> str:
