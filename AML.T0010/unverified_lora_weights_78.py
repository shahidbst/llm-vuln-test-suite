...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 78
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-78")
def generate_78(text: str) -> str:
