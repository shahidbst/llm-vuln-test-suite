...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: LangChain tool loaded from third-party source without review, variant 95
...
tools = load_tools([f"community-tool-95"])  # third-party tool code not audited
llm = OpenAI()
