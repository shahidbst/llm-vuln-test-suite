...
# CWE: CWE-494
# SEVERITY: Critical
# DESCRIPTION: Typosquatted LLM library installed instead of legitimate package, variant 27
...
import subprocess
subprocess.run(["pip","install",f"openai-27"])  # possible typosquat
# Legitimate package is 'openai'; 'openai-27' may be malicious
