...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 58
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-58")
def generate_58(text: str) -> str:
