...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 59
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-59")
def embed_59(text: str) -> list:
