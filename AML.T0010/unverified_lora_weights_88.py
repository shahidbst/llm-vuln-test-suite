...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 88
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-88")
def generate_88(text: str) -> str:
