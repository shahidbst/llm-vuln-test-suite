...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 49
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-49")
def embed_49(text: str) -> list:
