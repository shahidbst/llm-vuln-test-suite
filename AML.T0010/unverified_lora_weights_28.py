...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 28
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-28")
def generate_28(text: str) -> str:
