...
# CWE: CWE-915
# SEVERITY: High
# DESCRIPTION: Vector database populated from untrusted external source, variant 26
...
collection = client.create_collection(f"knowledge_26")
external_docs = __import__("requests").get(f"https://third-party.com/docs/26").json()
