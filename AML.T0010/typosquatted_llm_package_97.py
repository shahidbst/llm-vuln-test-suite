...
# CWE: CWE-494
# SEVERITY: Critical
# DESCRIPTION: Typosquatted LLM library installed instead of legitimate package, variant 97
...
import subprocess
subprocess.run(["pip","install",f"openai-97"])  # possible typosquat
# Legitimate package is 'openai'; 'openai-97' may be malicious
