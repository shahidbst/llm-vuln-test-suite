...
# CWE: CWE-502
# SEVERITY: High
# DESCRIPTION: LoRA adapter weights loaded from unverified community source, variant 38
...
model = PeftModel.from_pretrained(base, f"community-user/my-lora-38")
def generate_38(text: str) -> str:
