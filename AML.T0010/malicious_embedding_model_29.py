...
# CWE: CWE-829
# SEVERITY: High
# DESCRIPTION: Embedding model from unverified source used in production RAG pipeline, variant 29
...
embedder = SentenceTransformer(f"unverified-org/embedding-model-29")
def embed_29(text: str) -> list:
