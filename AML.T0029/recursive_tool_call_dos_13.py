...
# CWE: CWE-400
# SEVERITY: Critical
# DESCRIPTION: Agent tool calls can be crafted to recurse infinitely, causing DoS, variant 13
# EXPLOIT: Craft input that causes agent to invoke itself recursively via tool calls

import openai, json
def recursive_agent_13(task: str, depth=0):
    ...
    if msg.tool_calls:
        ...
        recursive_agent_13(args["task"], depth+1)  # VULNERABLE: unbounded recursion
