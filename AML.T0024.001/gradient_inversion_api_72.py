...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 72
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-72")
t = AutoTokenizer.from_pretrained("org/model-72")
@app.route("/grad/72", methods=["POST"])
def grad_72():
