...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 32
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-32")
t = AutoTokenizer.from_pretrained("org/model-32")
@app.route("/grad/32", methods=["POST"])
def grad_32():
