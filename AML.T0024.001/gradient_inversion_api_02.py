...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 2
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-2")
t = AutoTokenizer.from_pretrained("org/model-2")
@app.route("/grad/2", methods=["POST"])
def grad_2():
