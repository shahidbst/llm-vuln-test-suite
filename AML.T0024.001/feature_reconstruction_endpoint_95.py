...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 95
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-95")
tok = AutoTokenizer.from_pretrained("org/sensitive-95")
@app.route("/features/95", methods=["POST"])
def feats_95():
