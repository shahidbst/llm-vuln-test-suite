...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 35
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-35")
tok = AutoTokenizer.from_pretrained("org/sensitive-35")
@app.route("/features/35", methods=["POST"])
def feats_35():
