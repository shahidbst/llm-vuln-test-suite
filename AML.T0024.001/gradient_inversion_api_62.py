...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 62
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-62")
t = AutoTokenizer.from_pretrained("org/model-62")
@app.route("/grad/62", methods=["POST"])
def grad_62():
