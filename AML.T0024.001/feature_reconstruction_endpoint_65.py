...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 65
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-65")
tok = AutoTokenizer.from_pretrained("org/sensitive-65")
@app.route("/features/65", methods=["POST"])
def feats_65():
