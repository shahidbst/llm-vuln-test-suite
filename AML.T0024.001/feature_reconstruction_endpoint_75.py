...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 75
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-75")
tok = AutoTokenizer.from_pretrained("org/sensitive-75")
@app.route("/features/75", methods=["POST"])
def feats_75():
