...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 12
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-12")
t = AutoTokenizer.from_pretrained("org/model-12")
@app.route("/grad/12", methods=["POST"])
def grad_12():
