...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 92
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-92")
t = AutoTokenizer.from_pretrained("org/model-92")
@app.route("/grad/92", methods=["POST"])
def grad_92():
