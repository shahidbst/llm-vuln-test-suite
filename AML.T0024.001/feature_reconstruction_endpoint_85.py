...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 85
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-85")
tok = AutoTokenizer.from_pretrained("org/sensitive-85")
@app.route("/features/85", methods=["POST"])
def feats_85():
