...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Gradient computation accessible allowing model inversion, variant 82
...
app = Flask(__name__)
m = AutoModelForCausalLM.from_pretrained("org/model-82")
t = AutoTokenizer.from_pretrained("org/model-82")
@app.route("/grad/82", methods=["POST"])
def grad_82():
