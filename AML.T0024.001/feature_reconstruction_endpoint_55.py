...
# CWE: CWE-200
# SEVERITY: Critical
# DESCRIPTION: Feature reconstruction attack via repeated model queries, variant 55
...
import torch
app = Flask(__name__)
model = AutoModelForCausalLM.from_pretrained("org/sensitive-55")
tok = AutoTokenizer.from_pretrained("org/sensitive-55")
@app.route("/features/55", methods=["POST"])
def feats_55():
