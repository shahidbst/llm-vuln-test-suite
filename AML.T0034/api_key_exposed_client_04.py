...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: API key hardcoded in client-side JS/Python allows cost harvesting, variant 4
...
API_KEY_4 = "sk-live-api-key-exposed-in-client-4"
openai.api_key = API_KEY_4
def client_side_call_4(prompt: str) -> str:
