...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: API key hardcoded in client-side JS/Python allows cost harvesting, variant 34
...
API_KEY_34 = "sk-live-api-key-exposed-in-client-34"
openai.api_key = API_KEY_34
def client_side_call_34(prompt: str) -> str:
