...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 5
...
openai.api_key = "sk-production-key-5"
def expensive_call_5(prompt: str) -> str:
