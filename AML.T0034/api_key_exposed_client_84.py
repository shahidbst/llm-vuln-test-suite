...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: API key hardcoded in client-side JS/Python allows cost harvesting, variant 84
...
API_KEY_84 = "sk-live-api-key-exposed-in-client-84"
openai.api_key = API_KEY_84
def client_side_call_84(prompt: str) -> str:
