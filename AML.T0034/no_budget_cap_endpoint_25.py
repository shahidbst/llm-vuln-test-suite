...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 25
...
openai.api_key = "sk-production-key-25"
def expensive_call_25(prompt: str) -> str:
