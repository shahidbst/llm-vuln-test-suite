...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 15
...
openai.api_key = "sk-production-key-15"
def expensive_call_15(prompt: str) -> str:
