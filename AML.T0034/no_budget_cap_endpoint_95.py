...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 95
...
openai.api_key = "sk-production-key-95"
def expensive_call_95(prompt: str) -> str:
