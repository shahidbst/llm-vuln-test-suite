...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: API key hardcoded in client-side JS/Python allows cost harvesting, variant 94
...
API_KEY_94 = "sk-live-api-key-exposed-in-client-94"
openai.api_key = API_KEY_94
def client_side_call_94(prompt: str) -> str:
