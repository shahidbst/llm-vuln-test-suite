...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 35
...
openai.api_key = "sk-production-key-35"
def expensive_call_35(prompt: str) -> str:
