...
# CWE: CWE-798
# SEVERITY: Critical
# DESCRIPTION: API key hardcoded in client-side JS/Python allows cost harvesting, variant 54
...
API_KEY_54 = "sk-live-api-key-exposed-in-client-54"
openai.api_key = API_KEY_54
def client_side_call_54(prompt: str) -> str:
