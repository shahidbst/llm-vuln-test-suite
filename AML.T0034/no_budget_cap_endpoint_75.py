...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 75
...
openai.api_key = "sk-production-key-75"
def expensive_call_75(prompt: str) -> str:
