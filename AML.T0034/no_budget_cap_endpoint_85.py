...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 85
...
openai.api_key = "sk-production-key-85"
def expensive_call_85(prompt: str) -> str:
