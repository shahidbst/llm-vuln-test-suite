...
# CWE: CWE-400
# SEVERITY: Critical
# DESCRIPTION: Agent loop with no iteration limit allows infinite cost spiral, variant 87
# EXPLOIT: Craft prompt that causes agent to loop indefinitely, each iteration costing money

import openai
def agent_87(goal: str, max_iter=None):  # VULNERABLE: None means no limit
