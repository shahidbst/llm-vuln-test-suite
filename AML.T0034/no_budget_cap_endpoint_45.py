...
# CWE: CWE-400
# SEVERITY: High
# DESCRIPTION: No spending cap or budget alert on API account allows unconstrained cost harvesting, variant 45
...
openai.api_key = "sk-production-key-45"
def expensive_call_45(prompt: str) -> str:
